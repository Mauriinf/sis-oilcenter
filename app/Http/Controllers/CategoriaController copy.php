...
class CategoriaController extends Controller
{
    ...
    {
         $this->middleware('permission:lista-categorias|registrar-categorias|editar-categorias|habilitar-inhabilitar-categorias', ['only' => ['index','store']]);
         ...
         $this->middleware('permission:habilitar-inhabilitar-categorias', ['only' => ['enable','disable']]);
    }
